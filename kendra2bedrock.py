...
boto3.setup_default_session(profile_name=os.getenv('profile_name')) ## This line is needed when testing from machine 
##boto3.setup_default_session(region_name='us-west-2') ## This line is needed when testing ec2 instance
...
Stricktly dont privide any answer outside context. Do not use sources outside context provided. 
Provide an answer and provide sources and the context source link to where the relevant information can be found. Include this at the end of the response
...
If you dont find an answer from the context, ask user to contact abc@thesatwik.com
Use the provided examples as reference
Greet the user based on time of the day.
finally provide the context document link and URL
